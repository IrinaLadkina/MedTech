...
<@common.page title="Товары">
                    ...
                    <#list techTypes as typ>
                        <#list typ.techs as t>
                            <tr>
                                ...
                                <td class="col-3"><a class="btn btn-primary btn-sm" href="/client/tech/${t.id}">Подробнее</a></td>
                            </tr>
                        </#list>
                    </#list>
                </table>
    ...
    <script>
        function onSearch() {
            ...
            var request = search == null? "//localhost:8080/client/techs" :
                "//localhost:8080/client/techs?search="+search;
